 ...
 */
	public static void main(String[] args) {
		...
		try
		{
			...
			{
			ArrayList<Object> objetoA=new ArrayList<Object>();
			
			objetoA = factory.tipoLista2(seleccion1, seleccion2, instrucciones);
			resultado=calculadoraPrubea.calcularArrayList(objetoA);
			}
